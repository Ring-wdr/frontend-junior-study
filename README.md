# frontend-junior-study (Rsbuild project)

프론트엔드 커리큘럼에 따라 **주차별로 학습 계획**을 정리했습니다. 각 주차에는 해당 주제의 핵심 개념 요약과 함께 **공부 자료 및 블로그 링크**를 제공하며, 이론 학습과 실습(코딩 연습)을 **혼합**하여 진행할 수 있도록 안내합니다. 학습 중 모르는 용어나 개념은 연결된 자료를 통해 심화 조사하세요.
