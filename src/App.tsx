...
const router = createHashRouter([
  {
    ...
    children: [
      ...
      },
      {
        path: 'week-18',
        lazy: async () => {
          const { default: Week18Page } = await import('./page/week18/page');
          return { Component: Week18Page };
        },
      },
      {
        path: 'week-19',
        lazy: async () => {
          const { default: Week19Page } = await import('./page/week19/page');
          return { Component: Week19Page };
        },
      },
      {
        path: 'week-20',
        lazy: async () => {
          const { default: Week20Page } = await import('./page/week20/page');
      ...
      },
      {
        path: 'week-22',
        lazy: async () => {
          const { default: Week22Page } = await import('./page/week22/page');
          return { Component: Week22Page };
        },
      },
    ],
  },
