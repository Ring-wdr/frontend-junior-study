...
const sections = [
  { id: 'why-ts', component: <WhyTypescriptSection /> },
  { id: 'basics', component: <TypeBasicsSection /> },
  { id: 'advanced-types', component: <AdvancedTypesSection /> },
  { id: 'generics', component: <GenericsSection /> },
  { id: 'utility', component: <UtilityTypesSection /> },
  { id: 'conditional', component: <ConditionalTypesSection /> },
  { id: 'patterns', component: <PracticalPatternsSection /> },
];
