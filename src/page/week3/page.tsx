...
import { ContainerPresentationalSection } from './components/container-presentational-section';
import { PerformanceSection } from './components/performance-section';

const tabs = ['all', 'atomic', 'container', 'patterns', 'performance'] as const;
type Tab = (typeof tabs)[number];

const sections = [
  { id: 'atomic', component: <AtomicDesignSection /> },
  { id: 'container', component: <ContainerPresentationalSection /> },
  { id: 'patterns', component: <ComponentPatternsSection /> },
    ...
    <div className="min-h-screen bg-[#F0F4F8] font-sans text-gray-900 flex flex-col items-center">
      <header className="w-full max-w-3xl pt-12 pb-6 px-6 text-center">
        ...
        <p className="text-lg text-gray-600 max-w-xl mx-auto">
          Explore Front-end Design Patterns, Atomic Design, and Performance
          Optimizations.
        </p>
      </header>
