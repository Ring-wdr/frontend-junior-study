...
import { AnimatePresenceSection } from './components/animate-presence-section';
import { DragSection } from './components/drag-section';
import { GestureSection } from './components/gesture-section';
import { LayoutAnimationSection } from './components/layout-animation-section';
import { MotionBasicsSection } from './components/motion-basics-section';
...
const sections = [
  { id: 'basics', component: <MotionBasicsSection /> },
  { id: 'variants', component: <VariantsSection /> },
  { id: 'gesture', component: <GestureSection /> },
  { id: 'drag', component: <DragSection /> },
  { id: 'layout', component: <LayoutAnimationSection /> },
  { id: 'presence', component: <AnimatePresenceSection /> },
    ...
    <div className="min-h-screen bg-[#F0F4F8] font-sans text-gray-900 flex flex-col items-center">
      <header className="w-full max-w-3xl pt-12 pb-6 px-6 text-center">
        ...
        <p className="text-lg text-gray-600 max-w-xl mx-auto">
          Master React animations with Framer Motion: gestures, drag, layout
          animations, page transitions, and performance optimization.
        </p>
      </header>
