  ...
  return (
    ...
    >
      <div className="space-y-8">
        <SubSection
          title={t('accessibility.checklist.title')}
          icon
          iconColor="red"
        >
          <InfoBox variant="red" title={t('accessibility.checklist.infoTitle')}>
            <ul className="list-disc pl-5 space-y-3 text-sm text-gray-700">
              <li>
                <strong>{t('accessibility.checklist.focusRings')}</strong>{' '}
                <Trans
                  t={t}
                  i18nKey="accessibility.checklist.focusRingsDesc"
              ...
              <li>
                <strong>{t('accessibility.checklist.contrast')}</strong>{' '}
                {t('accessibility.checklist.contrastDesc')}
              </li>
              <li>
                <strong>{t('accessibility.checklist.reducedMotion')}</strong>{' '}
                {t('accessibility.checklist.reducedMotionDesc')}
                <br />
              ...
              <li>
                <strong>{t('accessibility.checklist.colorAlone')}</strong>{' '}
                {t('accessibility.checklist.colorAloneDesc')}
              </li>
            </ul>
          </InfoBox>
        </SubSection>
