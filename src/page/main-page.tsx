...
const getWeekColors = (week: number) => {
  ...
  switch (week) {
    ...
    case 16:
      return {
        badge: 'text-sky-600 bg-sky-50 group-hover:bg-sky-100',
        title: 'group-hover:text-sky-600',
      };
    case 17:
      return {
        badge: 'text-fuchsia-600 bg-fuchsia-50 group-hover:bg-fuchsia-100',
    ...
    case 21:
      return {
        badge: 'text-lime-600 bg-lime-50 group-hover:bg-lime-100',
        title: 'group-hover:text-lime-600',
      };
    case 22:
      return {
        badge: 'text-slate-600 bg-slate-50 group-hover:bg-slate-100',
